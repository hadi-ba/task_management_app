  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=open]:border-main-purple body-l",
        "w-full rounded-[4px] border border-solid border-[rgba(130,143,163,0.25)] dark:bg-dark-grey",
        className
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "body-l text-medium-grey focus:bg-main-purple/25",
        className
      )}
      {...props}
    >
      <span className="absolute right-2 flex size-3.5 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <CheckIcon className="size-4 text-main-purple" />
        </SelectPrimitive.ItemIndicator>
      </span>
